...
abstract contract DelayedReveal is IDelayedReveal {
    ...
    /// @dev Get the delayed reveal data by a batchId.
    function _getEncryptedData(uint256 _batchId) internal view returns (bytes memory data) {
        return encryptedData[_batchId];
    }
