...
```solidity
function verifyClaimMerkleProof(uint256 _conditionId, address _claimer, uint256 _tokenId, uint256 _quantity, bytes32[] _proofs, uint256 _proofMaxQuantityPerTransaction) public view returns (bool validMerkleProof, uint256 merkleProofIndex)
```
...
```solidity
function verifyClaimMerkleProof(uint256 _conditionId, address _claimer, uint256 _quantity, bytes32[] _proofs, uint256 _proofMaxQuantityPerTransaction) public view returns (bool validMerkleProof, uint256 merkleProofIndex)
```
...
```solidity
event ClaimConditionsUpdated(uint256 tokenId, struct IClaimCondition.ClaimCondition[] claimConditions)
```
...
```solidity
event ClaimConditionsUpdated(struct IClaimCondition.ClaimCondition[] claimConditions)
```
